        ...
        <footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* Left Section */}
                    <div>
                        <h3 className="text-2xl font-bold mb-4">Progym</h3>
                        <p className="mb-4">
                        ...
                        <div className="flex items-center">
                            <input
                                ...
                                className="bg-gray-800 text-white py-2 px-4 rounded-l-lg focus:outline-none w-full"
                            />
                            <button className="bg-yellow-500 text-black py-2 px-4 rounded-r-lg">
                                <FaPaperPlane />
                            </button>
                        </div>
                    </div>
                ...
                <div className="text-center text-sm mt-8 border-t border-gray-700 pt-4">
                    <p>
                        Copyright &amp; Design By <a href="#" className="text-yellow-500">@progym</a> - 2024. All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
