...
interface GymClass {
    ...
    duration: string;
    schedule: string;
    image?: any; // Changed to string to store base64 image data
}
...
export default function ClassesPage() {
    ...
    const handleRemove = (id: number) => {
        ...
        toast.success("Class Booked Successfylly");
    };
                ...
                {classes?.map((gymClass) => (
                    ...
                    >
                        ...
                        <div className="mt-4 flex justify-between">
                            ...
                            <button
                                className="bg-primary w-full text-black font-bold py-1 px-3 rounded-lg shadow-md"
